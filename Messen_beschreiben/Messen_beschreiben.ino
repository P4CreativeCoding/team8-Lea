...
byte blockcontent[16] = {"BPM: hier myBPM"};//an array with 16 bytes to be written into one of the 64 card blocks is defined!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
{ 
 int myBPM = pulseSensor.getBeatsPerMinute();  // Calls function on our pulseSensor object that returns BPM as an "int".
  ...
  //Serial.println(myBPM);                        // Print the value inside of myBPM. 
    ...
    digitalWrite(PIN_TO_ACTIVATE, HIGH);  // Pin aktivieren (HIGH = 5V)
  } else
  {
    digitalWrite(PIN_TO_ACTIVATE, LOW);  // Pin aktivieren (HIGH = 5V)
  }

    //delay(20);                    // considered best practice in a simple sketch.


  if (myBPM >= 90 || myBPM <= 50) {
